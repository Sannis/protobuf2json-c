...
TEST_DECLARE(json2protobuf_string__bar__error_is_not_string_required_for_string)
TEST_DECLARE(json2protobuf_string__bar__error_is_not_string_required_for_bytes)
...
TASK_LIST_START
  ...
  TEST_ENTRY(json2protobuf_string__bar__error_is_not_string_required_for_string)
  TEST_ENTRY(json2protobuf_string__bar__error_is_not_string_required_for_bytes)
