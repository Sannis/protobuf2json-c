...
TEST_DECLARE(json2protobuf_string__numeric_values__error_int32_is_not_integer)
...
TASK_LIST_START
  ...
  TEST_ENTRY(json2protobuf_string__numeric_values__error_int32_is_not_integer)
TASK_LIST_END
